...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'team_app.authentication.JWTAuthentication',
...
STATIC_URL = f'https://{AWS_S3_CUSTOM_DOMAIN}/static/team-service/'

MEDIA_URL = f'https://{AWS_S3_CUSTOM_DOMAIN}/media/team-service/'
