...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'payment_service.authentication.JWTAuthentication',
...
STATIC_URL = f'https://{AWS_S3_CUSTOM_DOMAIN}/static/payment-service/'

MEDIA_URL = f'https://{AWS_S3_CUSTOM_DOMAIN}/media/payment-service/'
