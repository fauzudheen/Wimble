...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'communication_service.authentication.JWTAuthentication',
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            'hosts': [('communication-redis', 6379)],
        },
    },
}
...
STATIC_URL = f'https://{AWS_S3_CUSTOM_DOMAIN}/static/communication-service/'

MEDIA_URL = f'https://{AWS_S3_CUSTOM_DOMAIN}/media/communication-service/'
