...
const TeamsLayout = () => {
  ...
  const tabs = [
    { name: 'My Teams', icon: UsersIcon, component: MyTeams },
    { name: 'Find Team', icon: MagnifyingGlassIcon, component: FindTeam },
    { name: 'Create Team', icon: PlusIcon, component: CreateTeam },
  ];
