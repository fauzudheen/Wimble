...
const Navbar = () => {
    ...
    return (
        <header className="bg-white dark:bg-gray-900 shadow-md">
            <div className="mx-auto px-1 sm:px-2 lg:px-6">
                <div className="flex justify-between items-center h-16">
                    <div className="flex items-center">
                        <button onClick={toggleSidebar} className="text-gray-500 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 focus:outline-none mr-2 lg:hidden">
                            <svg className="h-4 w-5 sm:h-6 sm:w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="flex-1 flex items-center justify-center px-1 sm:px-2 lg:ml-6 lg:justify-start">
                        <div className="max-w-lg w-full lg:max-w-xs" ref={searchRef}>
                            <form onSubmit={handleSearchSubmit} className="relative">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <svg className="h-3 w-3 sm:h-5 sm:w-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <input
                                    type="text"
                                    placeholder="Search..."
                                    className="block w-full pl-6 pr-2 py-1 sm:pl-10 sm:pr-3 sm:py-2 border text-xs sm:text-sm
                                    dark:text-white border-gray-300 rounded-md leading-5 bg-white dark:bg-gray-700 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-teal-500 focus:border-teal-500"
                                    value={searchQuery}
                                ...
                                <button type="submit" className="absolute inset-y-0 right-0 pr-3 flex items-center">
                                    ...
                                    <svg className="h-3 w-3 sm:h-5 sm:w-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div className="flex items-center space-x-2 sm:space-x-4">
                        {isAuthenticated ? (
                            <>
                                <Link to='/pricing' className={`${Colors.tealBlueGradientText} text-xs sm:text-sm md:text-base`}>
                                    Pricing
                                </Link>
