    ...
    return (
      <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md transition-all duration-200 ease-in-out hover:shadow-lg">
        <div className="flex items-start space-x-3">
          <img src={`${GatewayUrl}api/user_service/media/${comment.user_data.profile.split('/media/media/')[1]}`} alt={`${comment.user_data.first_name} ${comment.user_data.last_name}`} className="w-10 h-10 rounded-full" />
