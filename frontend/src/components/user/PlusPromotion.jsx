...
const PlusPromotion = () => {
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 mt-4">
      <h3 className="text-sm md:text-base font-semibold text-gray-900 dark:text-gray-100 mb-2">Upgrade to Plus</h3>
      ...
      <div className='flex justify-center'>
        <button className={`text-xs md:text-sm text-white rounded-md shadow ${Buttons.tealBlueGradientHoverButton}`}>
          Upgrade Now
        </button>
      </div>
    </div>
