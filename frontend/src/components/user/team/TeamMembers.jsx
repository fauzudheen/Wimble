...
import { UserPlus, UserMinus, Bell, Users, User } from 'lucide-react';
      ...
      {activeTab === 'existing' ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {pendingRequests.length > 0 ? (
            ...
            <p className="col-span-full text-center text-sm text-gray-500 dark:text-gray-400">No pending requests.</p>
          )}
        </div>
      )}
    </div>
